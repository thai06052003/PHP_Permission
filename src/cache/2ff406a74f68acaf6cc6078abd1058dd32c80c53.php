<?php $__env->startSection('content'); ?>
    ...
    <form action="" method="POST">
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" placeholder="Tên vai trò..." value="<?php echo e($role->name); ?>" required>
        </div>
        <p>Danh sách quyền</p>
                        ...
                        <td>
                            <div class="row">
                                <?php $__currentLoopData = $module->actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-3">
                                        <label for="">
                                            <input type="checkbox" name="permissions[]" id="" value="<?php echo e($module->name.'.'.$action->name); ?>" <?php echo e(isPermission($role->permissions, $module->name.'.'.$action->name) ? 'checked' : ''); ?>>
